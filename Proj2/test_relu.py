...
#----------------------------------------------
    ...
    def backward(self):
        self.gradient = self.error * self.dRelu(self.output);
    ...
    def forward(self):
        ...
        self.output = self.Relu(Output_sum)    
...
def main():
    ...
    while (idx<7):           
        ...
        print ("Training error: ", train_err_percent,"%","(",round(train_err.item(),0),"/",nb_training_points,")")                    
    ...
    print ("Testing error: ", test_err_percent,"%","(",round(test_err.item(),0),"/",nb_testing_points,")")        
